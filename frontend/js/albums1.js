...
router.put('/:id', async (req, res) => {
    ...
    const { title, artist, cover_url, type, release_date, release_year, genres, label, language, tracks } = req.body;
    ...
    try {
        ...
        // Обновляем основную информацию альбома
        ...
        await connection.execute('DELETE FROM tracks WHERE album_id = ?', [albumId]);
